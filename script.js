...
function initCharts() {
    ...
    // --- НОВІ КОНСТАНТИ ---
    const PURPLE_COLOR = 'rgb(147, 112, 219)'; // Medium Purple для Настрою
    const PURPLE_AREA = 'rgba(147, 112, 219, 0.4)'; 
    const LIME_COLOR = 'rgb(50, 205, 50)'; // Lime Green для Готовності
    ...
    const charts = [
        ...
        // САЛАТОВИЙ (Готовність) <--- ЗМІНА ТУТ
